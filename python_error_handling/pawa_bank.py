...
def exception(cls):
    return type(cls.__name__, (cls, Exception,), {})
...
class InsufficientFundsError:
    def __init__(self, balance, amount, minimum_balance):
        ...
        self.message = (f"Insufficient funds: Current balance {balance}, "
...
class InvalidTransactionError:
    ...
    def __init__(self, amount):
        self.amount = amount
        self.message = f"Invalid transaction: {amount}. Withdrawal amount must be greater than 0."
        super().__init__(self.message)
